...
export const PRICING_DEFAULTS = {
  ...
  faixas: {
    ...
    email: [
      { min: 0, max: 1000000, preco: 0.015 },
      { min: 1000001, max: 5000000, preco: 0.012 },
      { min: 5000001, max: 10000000, preco: 0.01 },
  ...
  precos: {
    rcs_basico: 0.35, // RCS Conversacional/Sessão
    imagem_fatura: 0.025,
