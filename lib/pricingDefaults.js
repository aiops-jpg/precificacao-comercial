...
export const PRICING_DEFAULTS = {
  ...
  // Cartas/Físico (aba "Cartas Ajustada Abril 26") — Preço Unitário já com imposto e margem.
  // 4 tipos x 2 formatos x 4 combinações de impressão = 32 preços. Só elegível a partir de
  // 25.000 postagens/mês — cobre todo o processo (higienização, impressão, postagem, logística
  // reversa). Selecionado por Tipo + Formato/Impressão na calculadora (preço varia até 24x entre
  // o mais simples e o mais completo, então não dá pra assumir um valor único).
  cartasFisico: {
    mdp_basica: {
      nome: 'MDP-Básica',
      A4: { '1x1': 2.03, '2x1': 2.09, '4x1': 2.14, '4x4': 2.25 },
      A3: { '1x1': 2.45, '2x1': 2.50, '4x1': 2.56, '4x4': 2.64 },
    },
    fac_simples: {
      nome: 'FAC Carta Simples',
      A4: { '1x1': 4.22, '2x1': 4.27, '4x1': 4.33, '4x4': 4.44 },
      A3: { '1x1': 4.64, '2x1': 4.69, '4x1': 4.74, '4x4': 4.83 },
    },
    registrada_sem_ar: {
      nome: 'Carta Registrada sem AR',
      A4: { '1x1': 25.44, '2x1': 25.50, '4x1': 25.55, '4x4': 25.66 },
      A3: { '1x1': 25.86, '2x1': 25.91, '4x1': 25.97, '4x4': 26.05 },
    },
    registrada_com_ar: {
      nome: 'Carta Registrada com AR',
      A4: { '1x1': 47.60, '2x1': 47.66, '4x1': 47.71, '4x4': 47.82 },
      A3: { '1x1': 48.02, '2x1': 48.07, '4x1': 48.13, '4x4': 48.21 },
    },
  },
  ...
  setup: {
    one_horas_incluidas: 200, // horas de implantação inclusas no setup do ONE Platform (nota do slide 13)
    one_franquia_minima: 0, // franquia mínima de mensageria do ONE Platform, R$ (nota do slide 13)
