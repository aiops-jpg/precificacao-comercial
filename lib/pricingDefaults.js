...
export const PRICING_DEFAULTS = {
  ...
  setup: {
    ...
    horas_incluidas: 200, // escopo padrão do setup (ONE, Agentes Digitais, WhatsApp, RCS) — acima disso, cobra hora extra
  },
  ...
  precos: {
    ...
    hora_desenvolvimento: 250, // R$/h de dev/customização além das horas_incluidas do setup padrão (ONE, Agentes Digitais, WhatsApp, RCS)
  ...
  notas: {
    ...
    chatbot: 'Franquia mínima de R$4.000/mês equivale a 10.000 atendimentos inclusos (10.000 × R$0,40).',
    dev_extra: 'O setup padrão de ONE, Agentes Digitais, WhatsApp e RCS cobre até as horas incluídas acima. Além disso, desenvolvimento/customização solicitada é cobrado por hora.',
  },
}
