...
export function getEdicoesPorSlide(result, discovery, config = PRICING_DEFAULTS) {
  ...
  if (ativo('one_platform')) {
    ...
    const emailOuPortalAtivo = ativo('email') || ativo('portal_negociacao')
  ...
  const landingAtivoSlide20 = ativo('landing_page_link')
  add(20, cardOuRemove(landingAtivoSlide20, 'Google Shape;818;p61', formatMoneyPreciso(result.precos.landing_page_link),
