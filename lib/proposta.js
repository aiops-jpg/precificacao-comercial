...
export function getEdicoesPorSlide(result, discovery, config = PRICING_DEFAULTS) {
  ...
  // Enriquecimento e Valida+ compartilham uma caixa (797/799/800/820).
  add(20, cardOuRemove(precoEnriquecimentoSlide20 !== null, 'Google Shape;802;p61', formatMoneyPreciso(precoEnriquecimentoSlide20 || 0), ['Google Shape;801;p61']))
  add(20, cardOuRemove(ativo('valida_mais'), 'Google Shape;811;p61', formatMoneyPreciso(result.precos.valida_mais), ['Google Shape;810;p61']))
  if (precoEnriquecimentoSlide20 === null && !ativo('valida_mais')) {
