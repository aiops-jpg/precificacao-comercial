export const CANAIS_BLOCOS = [
  { bloco: 'Canais de Mensageria', grupos: [
    ...
    { grupo: 'WhatsApp Mobile', itens: [
      { key: 'whats_mobile', label: 'WhatsApp Mobile (revenda)' },
    ]},
    { grupo: 'Smart Contact', itens: [
      { key: 'smart_contact_phone_score', label: 'Smart Contact Phone — Score' },
      { key: 'smart_contact_phone_enriquecimento', label: 'Smart Contact Phone — Enriquecimento + Score' },
      { key: 'smart_contact_email_score', label: 'Smart Contact Email — Score' },
      { key: 'smart_contact_email_enriquecimento', label: 'Smart Contact Email — Enriquecimento + Score' },
    ]},
  ...
  { bloco: 'Sistemas/Plataformas', grupos: [
    ...
    { grupo: 'Kami', itens: [
      { key: 'kami_robo_localizacao', label: 'Kami Voz — Robô Localização' },
      { key: 'kami_robo_negociacao', label: 'Kami Voz — Robô Negociação' },
      { key: 'kami_texto', label: 'Kami Texto' },
    ]},
    { grupo: 'Portal', itens: [
